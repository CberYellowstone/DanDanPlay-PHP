<?php
global $video_root_path, $data_path, $version, $web_users, $able_cache, $able_webp, $cache_limit, $api_authkey, $api_needkey, $remote_port, $remote_addres, $convert_trad_to_simpl;
